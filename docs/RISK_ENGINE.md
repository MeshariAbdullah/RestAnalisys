...
| Zero rentals (first-time)        | -5      |
| Each disputed rental             | -10     |
| Each late return                 | -5      |
...
- The full feature snapshot (account age, completed rentals, etc.)
- The computed base score and final score
- The list of applied modifiers with deltas
