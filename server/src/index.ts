...
app.use("/api/auth/login", rateLimit({ windowMs: 15 * 60 * 1000, max: 20, keyPrefix: "auth" }));
app.use("/api/auth/register", rateLimit({ windowMs: 60 * 60 * 1000, max: 10, keyPrefix: "reg" }));
