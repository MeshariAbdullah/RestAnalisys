 ...
 *
 * Module layout:
 *   /api/auth          — registration, login, Nafath hooks, profile management
 ...
 *   /api/ratings       — post-rental reviews and asset ratings
 *   /api/extensions    — rental duration extension requests
 */
