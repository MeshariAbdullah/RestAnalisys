...
import { getLocalUploadDir } from "./services/uploadService.js";
...
app.listen(PORT, () => {
  ...
  console.log(`   S3:       ${process.env.S3_ACCESS_KEY ? "live" : "local"}`);
  console.log(`   Email:    ${process.env.EMAIL_PROVIDER_KEY ? "live" : "console"}`);
});
