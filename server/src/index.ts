...
import { apiLimiter, authLimiter, sensitiveActionLimiter } from "./middleware/rateLimiter.js";
...
app.use("/api/legal", sensitiveActionLimiter, legalRouter);
app.use("/api/payments", sensitiveActionLimiter, paymentsRouter);
