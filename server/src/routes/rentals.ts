...
router.post(
  ...
  asyncHandler(async (req: AuthedRequest, res) => {
    ...
    await notify({
      ...
      message: `Your asset "${asset.title}" has been rented (${reference}).`,
  ...
  asyncHandler(async (req: AuthedRequest, res) => {
    ...
    if (outcome === "clean") {
      ...
      await notify({
        ...
        type: "rental_closed",
        title: "Rental closed",
        message: `Rental ${rental.reference} has been closed successfully.`,
        linkUrl: `/my-rentals`,
      });
      await notify({
        ...
        message: `Rental ${rental.reference} for your asset was completed. Payout incoming.`,
