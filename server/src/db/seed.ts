  ...
  await db.insert(notifications).values([
    {
      ...
      message: `Your rental ${activeRental.reference} for "${asset2.title}" is now active.`,
      entityType: "rental",
      entityId: activeRental.id,
      read: true,
      readAt: startDate,
    },
    {
      ...
      message: `Your rental ${activeRental.reference} has been delivered. Enjoy!`,
      entityType: "rental",
      entityId: activeRental.id,
      read: true,
      readAt: startDate,
    },
    {
      ...
      message: `Payment for rental ${activeRental.reference} has been captured.`,
      entityType: "rental",
      entityId: activeRental.id,
      read: false,
    },
    {
      ...
      message: `"${asset2.title}" has been booked (${activeRental.reference}).`,
      entityType: "rental",
      entityId: activeRental.id,
      read: true,
      readAt: startDate,
    },
    {
      ...
      message: `Rental ${closedRental.reference} for your asset has been completed.`,
      entityType: "rental",
      entityId: closedRental.id,
      read: false,
    },
    {
      userId: owner.id,
      ...
      message: `A payout of ${(payout.netHalalas / 100).toLocaleString("en-SA")} SAR has been released.`,
      entityType: "payout",
      read: false,
    },
    {
      ...
      message: `A damage dispute has been opened for rental ${dispRental.reference}.`,
      entityType: "dispute",
      entityId: dispRental.id,
      read: false,
    },
    {
      userId: newRenter.id,
      ...
      message: `A dispute has been opened for your rental ${dispRental.reference}.`,
      entityType: "dispute",
      entityId: dispRental.id,
      read: false,
    },
    {
      ...
      message: `"${asset5.title}" by ${owner.fullName} is pending approval.`,
      entityType: "asset",
      entityId: asset5.id,
      read: false,
    },
    {
      userId: ops.id,
      type: "system_alert",
      title: "Rental Approaching End Date",
      message: `Rental ${activeRental.reference} is approaching its end date.`,
      entityType: "rental",
      entityId: activeRental.id,
      read: false,
    },
