        ...
        <div className="p-3 border-t border-neutral-800">
          ...
          {sidebarOpen ? (
            <div className="flex items-center gap-3">
              <Link href="/profile">
                <a className="w-9 h-9 bg-amber-500 rounded-full flex items-center justify-center shrink-0 hover:ring-2 hover:ring-amber-400 transition-all" title="Profile">
