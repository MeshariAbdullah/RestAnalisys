        ...
        <div className="p-3 border-t border-neutral-800">
          {sidebarOpen ? (
            <div className="flex items-center gap-3">
              <Link href="/profile">
                <a className="w-9 h-9 bg-amber-500 rounded-full flex items-center justify-center shrink-0 hover:ring-2 hover:ring-amber-300 transition-all">
                  <Shield className="w-4 h-4 text-neutral-950" />
                </a>
              </Link>
              <div className="flex-1 min-w-0">
                <Link href="/profile">
                  <a className="block hover:text-amber-400 transition-colors">
