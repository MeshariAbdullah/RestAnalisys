...
const NAV: NavItem[] = [
  ...
  { href: "/ops/rentals", label: "Rental Management", icon: Package, roles: ["operations"] },
  ...
  // Profile (all roles)
  { href: "/profile", label: "My Profile", icon: User, roles: ["renter", "owner", "inspector", "operations", "admin", "super_admin"] },
];
