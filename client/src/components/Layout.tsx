        ...
        <div className="p-3 border-t border-neutral-800">
          {sidebarOpen ? (
            <div className="flex items-center gap-3">
              <Link href="/profile">
                <a className="shrink-0 w-9 h-9 bg-amber-500 rounded-full flex items-center justify-center hover:bg-amber-400 transition-colors">
            ...
            <div className="space-y-2">
              <Link href="/profile">
                <a className="w-full flex justify-center p-2 rounded hover:bg-neutral-800 transition-colors text-neutral-400 hover:text-amber-400" title="Profile">
