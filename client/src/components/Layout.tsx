...
const NAV: NavItem[] = [
  ...
  { href: "/my-payments", label: "Payments", icon: Receipt, roles: ["renter"] },
  ...
  { href: "/owner/rentals", label: "Rental Activity", icon: FileText, roles: ["owner"] },
  ...
  { href: "/admin/audit", label: "Audit Log", icon: FileText, roles: ["admin", "super_admin"] },
];
