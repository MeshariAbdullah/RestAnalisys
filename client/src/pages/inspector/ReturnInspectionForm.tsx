    ...
    <div className="p-8 max-w-3xl mx-auto">
        ...
        <Card className="mb-6 border-blue-200 bg-blue-50/40">
          <CardContent className="p-4 text-sm">
            <p className="font-medium text-blue-900">
              Rental {activeRental.reference}
            </p>
            <p className="text-blue-800">
              {activeRental.startDate} — {activeRental.endDate} ({activeRental.durationDays} days)
            </p>
          </CardContent>
        </Card>
      )}
      ...
      <form onSubmit={handleSubmit}>
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <section>
              ...
              <Textarea
                ...
                placeholder="Describe any new damage, wear, or missing accessories…"
                rows={4}
                className="mt-3"
              />
            </section>
        ...
        <div className="flex gap-3 mt-6">
          <Button
            type="submit"
            disabled={submitting || !activeRental}
