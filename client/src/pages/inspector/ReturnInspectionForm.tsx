  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <p className="text-neutral-500 mb-8">
        {rental
          ? `Rental ${rental.reference} · returned for post-rental inspection`
          : "Inspect the returned asset for damage or condition changes."}
      </p>
          ...
          <CardContent className="p-6 space-y-6">
            <section>
              ...
              <Textarea
                ...
                placeholder="Verify serial numbers, compare intake photos…"
                rows={3}
              />
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="A">A — pristine / same as intake</SelectItem>
                      <SelectItem value="B">B — minor wear, acceptable</SelectItem>
                      <SelectItem value="C">C — visible wear / minor damage</SelectItem>
                      <SelectItem value="D">D — damaged / major issues</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
              <Textarea
                ...
                placeholder="Compare with intake photos. Note any new scratches, scuffs, stains, or missing parts…"
                rows={4}
                className="mt-3"
              />
            </section>
