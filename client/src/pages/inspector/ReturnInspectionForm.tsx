...
export default function ReturnInspectionForm({ assetId }: { assetId: number }) {
  ...
  const rental = allRentals?.[0];

  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    if (!rental) {
      setError("No active rental found for this asset");
      return;
    }
    setSubmitting(true);
    setError(null);
  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <p className="text-neutral-500 mb-2">
        Inspect the returned asset and assess condition changes.
      </p>
      {rental && (
        <p className="text-sm text-amber-600 mb-6">
          Rental {rental.reference} · {rental.durationDays} days · Rented {rental.startDate} to {rental.endDate}
        </p>
      )}
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <section>
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="C">C — visible damage</SelectItem>
              ...
              <Textarea
                ...
                placeholder="New scratches, missing accessories, stains..."
                rows={4}
                className="mt-3"
              />
            </section>
