  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <p className="text-neutral-500 mb-8">
        Inspect the returned asset and compare condition to the intake report.
      </p>
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <section>
              ...
              <Textarea
                ...
                placeholder="Describe any new scratches, scuffs, missing accessories, damage compared to intake…"
                rows={4}
                className="mt-3"
              />
            </section>
