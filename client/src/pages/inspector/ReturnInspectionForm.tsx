...
import { rentalsApi, inspectionsApi, formatSar } from "@/lib/api";
...
export default function ReturnInspectionForm({
  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <h1 className="text-3xl font-bold mb-1">Return inspection</h1>
      <p className="text-neutral-500 mb-4">
        Inspect the returned asset and compare against pre-rental condition.
      </p>
      ...
      {rental && (
        <Card className="mb-6 border-blue-200 bg-blue-50/40">
          <CardContent className="p-4 text-sm">
            ...
            <p>
              Total: <b>{formatSar(rental.totalPayableHalalas)}</b> ·
              Commitment: <b>{formatSar(rental.legalCommitmentHalalas)}</b> (
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <section>
              ...
              <Textarea
                ...
                placeholder="New scratches, scuffs, stains, missing parts…"
                rows={4}
                className="mt-3"
              />
            </section>
            ...
            <section>
              <h2 className="font-semibold mb-3">Post-rental valuation</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
