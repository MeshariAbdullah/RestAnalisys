  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <p className="text-neutral-500 mb-2">
        Assess the returned asset's condition after rental.
      </p>
      {rental && (
        <p className="text-sm text-neutral-400 mb-8">
          Rental: {rental.reference} | {rental.startDate} → {rental.endDate} ({rental.durationDays}d)
        </p>
      )}
      ...
      <form onSubmit={handleSubmit}>
        <Card>
          <CardContent className="p-6 space-y-6">
            <section>
              <h2 className="font-semibold mb-3">Authenticity verification</h2>
              ...
              <Textarea
                ...
                placeholder="Notes on serial match, any swapped components..."
                rows={3}
              />
            </section>

            <section>
              <h2 className="font-semibold mb-3">Condition assessment</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="A">A — pristine (no change)</SelectItem>
                      <SelectItem value="B">B — minor wear</SelectItem>
                      <SelectItem value="C">C — noticeable wear/damage</SelectItem>
                      <SelectItem value="D">D — significant damage</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
              <Textarea
                ...
                placeholder="New scratches, scuffs, stains, missing accessories compared to intake..."
                rows={4}
                className="mt-3"
              />
            </section>
                ...
                <div>
                  ...
                  {asset?.evaluatedValueHalalas && (
                    <p className="text-xs text-neutral-400 mt-1">
                      Previous: {formatSar(asset.evaluatedValueHalalas)}
                    </p>
                  )}
                </div>
                <div>
                  ...
                  <Input
                    ...
                    required
                  />
                  {asset?.dailyRentalPriceHalalas && (
                    <p className="text-xs text-neutral-400 mt-1">
                      Previous: {formatSar(asset.dailyRentalPriceHalalas)}
                    </p>
                  )}
                </div>
              </div>
            ...
            <section>
              <h2 className="font-semibold mb-3">Risk reassessment</h2>
              <Select
                value={riskCategory}
