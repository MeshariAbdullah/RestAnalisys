  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <p className="text-neutral-500 mb-8">
        Inspect the returned item and compare to intake condition.
      </p>
          ...
          <CardContent className="p-6 space-y-6">
            <section>
              ...
              <div className="flex items-center gap-4 mb-3">
                <label className="flex items-center gap-2 text-sm">
                  ...
                  />
                  Authentic — matches intake record
                </label>
                <label className="flex items-center gap-2 text-sm">
                  <input
                    type="radio"
            ...
            <section>
              ...
              <Textarea
                ...
                placeholder="Compare to intake: new scratches, missing accessories, stains…"
                rows={4}
                className="mt-3"
              />
            </section>
